...
import type { CooldownMove } from "./cooldownMoves";

type Props = {
  move: CooldownMove | null;
  moveIndex: number;
  totalMoves: number;
  count: number;
  target: number;
...
export default function CooldownOverlay({
  ...
  const displayCount = Math.max(target - count, 0);
  const unit = "s left";
  ...
  return (
    <View style={styles.overlay}>
      ...
      <View style={styles.content}>
        <Text style={styles.eyebrow}>COOLDOWN · Breathe and relax</Text>
        ...
        {hasScore && (
          <View style={styles.scoreRow}>
            <Text style={styles.scoreLabel}>HOLD QUALITY</Text>
        ...
        {hasFeedback ? (
          ...
          <View style={[styles.feedbackCard, { backgroundColor: "rgba(52, 211, 153, 0.1)", borderColor: "rgba(52, 211, 153, 0.2)" }]}>
            ...
            <Text style={[styles.feedbackText, { color: "#34D399" }]}>Hold is perfect! Relax into it.</Text>
          </View>
        ) : null}
        ...
        <View style={styles.buttonRow}>
          ...
          <TouchableOpacity style={styles.skipButton} onPress={onSkipAll}>
            ...
            <Text style={styles.skipText}>Skip Cooldown</Text>
          </TouchableOpacity>
        </View>
      </View>
    </View>
